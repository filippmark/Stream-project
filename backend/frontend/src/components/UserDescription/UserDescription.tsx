    ...
    return (
      <li className="usersSearchResult">
        <ul className="userSearchDetails">
          <li className="userSearchResultEmail">user: {this.props.email}</li>
          <li className="userSearchResultStartMail">
            <img
              className="createDialog"
              src={process.env.PUBLIC_URL + "/mail.png"}
              width="30px"
              onClick={this._createChatOrMoveToChat}
            />
          </li>
        </ul>
      </li>
